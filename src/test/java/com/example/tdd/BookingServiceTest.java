...
public class BookingServiceTest {
    ...
    @Before
    public void setup(){
        LocalDate checkIn = LocalDate.parse("2023-04-10");
        LocalDate checkOut = LocalDate.parse("2023-04-20");
        BookingModel bookingModel = new BookingModel("1", "test", checkIn, checkOut, 2);
